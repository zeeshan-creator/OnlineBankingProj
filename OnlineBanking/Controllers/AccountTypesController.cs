...
namespace OnlineBanking.Controllers
{
    ...
    public class AccountTypesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Account_Id,Account_Type,Min_Balance")] AccountType accountType)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Account_Id,Account_Type,Min_Balance")] AccountType accountType)
        {
            if (ModelState.IsValid)
            {
